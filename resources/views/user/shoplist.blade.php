...
<div class="shoplist__container" id="container">
  <div class="shoplist__content">
    ...
    <div class="content__cards">
      ...
      <div class="content__card" v-for="(item, index) in items" :key="items">
        <div class="card__img"><img :src="'/staticfiles/img/' + item.img" alt=""></div>
        <div class="card__info">
          <div class="info__title"><span class="info__title__text">@{{ item.name }}</span></div>
          ...
          <div class="info__delete"><a @click="deleteItem(index)">Удалить</a></div>
          <div class="info__price">
            <div class="price__actual"><span class="price__actual__text">@{{ item.price }} ₽</span></div>
            <div class="price__prev" v-if="item.prev_price"><span class="price__prev__text">@{{ item.previous_price }} ₽</span></div>
          </div>
        </div>
      </div>
    </div>
